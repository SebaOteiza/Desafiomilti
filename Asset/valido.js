...
function validarRango(elemento){
    ...
    //  var numero = prompt("¿Qué tabla quieres imprimir?");
      ...
      for(var i = 1; i < numero; i++ ) { //el ciclo va a parar cuando sea 11 porque necesitamos imprimir 10 lineas que son las 10 multiplicaciones de la tabla - con el 1++ le decimos al ciclo que cada vez que itere lo incremente
